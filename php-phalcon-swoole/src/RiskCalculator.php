 ...
 *
 * Cópia 1:1 de php-swoole/src/RiskCalculator.php — qualquer alteração aqui
 * deve ser espelhada em php-swoole/src/RiskCalculator.php e em
 * kotlin-coroutines/.../RiskCalculator.kt.
 */
